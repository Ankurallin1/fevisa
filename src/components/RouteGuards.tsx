...
/**
 * Route guard for booking flow - requires authentication
 */
export const BookingGuard: React.FC<{ children: React.ReactNode }> = ({ children }) => {
...
/**
 * Route guard for payment flow - requires authentication and booking data
 */
...
/**
 * Route guard for guest-only routes (login, signup, etc.)
 */
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Please verify your email address to access this page.</p>
          <button
