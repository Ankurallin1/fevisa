...
import type { Site, Contact } from '../lib/types/site';
...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    const contactData = StaticContentLoader.loadContact();
    setSite(siteData);
  ...
  const handleWhatsAppClick = () => {
    if (contact) {
      ...
      const whatsappLink = generateWhatsAppLink(contact.whatsapp, message);
      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p>&copy; 2024 VisaPro Services. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">{site.brandName}</h3>
            <p className="text-gray-300 mb-4">Australia Visa Services</p>
            <p className="text-gray-300 mb-4">{contact.address}</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; 2024 {site.brandName}. All rights reserved.
            </p>
